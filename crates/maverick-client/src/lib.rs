...
fn h2_pool_shutdown_summary(snapshot: H2ConnectionPoolSnapshot) -> String {
    format!(
        concat!(
            ...
            "idle_retirements={} ",
            "closed_retirements={} ",
            "runtime_stream_resets={} ",
            "runtime_send_stalls={} ",
            "connection_setup_duration_ms_count={} ",
            "connection_setup_duration_ms_sum={} ",
            "connection_setup_duration_ms_le_10={} ",
            "connection_setup_duration_ms_le_25={} ",
            "connection_setup_duration_ms_le_50={} ",
            "connection_setup_duration_ms_le_100={} ",
            "connection_setup_duration_ms_le_250={} ",
            "connection_setup_duration_ms_le_500={} ",
            "connection_setup_duration_ms_le_1000={} ",
            "connection_setup_duration_ms_le_2500={} ",
            "connection_setup_duration_ms_le_5000={} ",
            "connection_setup_duration_ms_le_10000={} ",
            "connection_setup_duration_ms_le_inf={} ",
            "tunnel_open_duration_ms_count={} ",
            "tunnel_open_duration_ms_sum={} ",
            "tunnel_open_duration_ms_le_10={} ",
            "tunnel_open_duration_ms_le_25={} ",
            "tunnel_open_duration_ms_le_50={} ",
            "tunnel_open_duration_ms_le_100={} ",
            "tunnel_open_duration_ms_le_250={} ",
            "tunnel_open_duration_ms_le_500={} ",
            "tunnel_open_duration_ms_le_1000={} ",
            "tunnel_open_duration_ms_le_2500={} ",
            "tunnel_open_duration_ms_le_5000={} ",
            "tunnel_open_duration_ms_le_10000={} ",
            "tunnel_open_duration_ms_le_inf={} ",
            "active_streams={} ",
            "cached_connection={} ",
            "shutdown={}"
        ),
    ...
    fn h2_shutdown_summary_has_a_fixed_privacy_safe_schema() {
        ...
        assert_eq!(
            ...
            concat!(
                ...
                "runtime_stream_resets=12 ",
                "runtime_send_stalls=13 ",
                "connection_setup_duration_ms_count=14 ",
                "connection_setup_duration_ms_sum=15 ",
                "connection_setup_duration_ms_le_10=16 ",
                "connection_setup_duration_ms_le_25=17 ",
                "connection_setup_duration_ms_le_50=18 ",
                "connection_setup_duration_ms_le_100=19 ",
                "connection_setup_duration_ms_le_250=20 ",
                "connection_setup_duration_ms_le_500=21 ",
                "connection_setup_duration_ms_le_1000=22 ",
                "connection_setup_duration_ms_le_2500=23 ",
                "connection_setup_duration_ms_le_5000=24 ",
                "connection_setup_duration_ms_le_10000=25 ",
                "connection_setup_duration_ms_le_inf=26 ",
                "tunnel_open_duration_ms_count=27 ",
                "tunnel_open_duration_ms_sum=28 ",
                "tunnel_open_duration_ms_le_10=29 ",
                "tunnel_open_duration_ms_le_25=30 ",
                "tunnel_open_duration_ms_le_50=31 ",
                "tunnel_open_duration_ms_le_100=32 ",
                "tunnel_open_duration_ms_le_250=33 ",
                "tunnel_open_duration_ms_le_500=34 ",
                "tunnel_open_duration_ms_le_1000=35 ",
                "tunnel_open_duration_ms_le_2500=36 ",
                "tunnel_open_duration_ms_le_5000=37 ",
                "tunnel_open_duration_ms_le_10000=38 ",
                "tunnel_open_duration_ms_le_inf=39 ",
                "active_streams=40 ",
                "cached_connection=false ",
                "shutdown=true"
            )
